    ...
    <footer className="bg-gray-800 text-white">
      <div className="max-w-6xl mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {/* Company Information */}
          <div>
            <h3 className="text-xl font-bold mb-4">CraftsMarket</h3>
            <p className="text-gray-300 mb-4">
              Connecting artisans with craft lovers around the world since 2020.
            </p>
          ...
          <div>
            ...
            <form className="flex">
              ...
              <button
                type="submit"
                className="bg-indigo-600 px-4 py-2 rounded-r text-white hover:bg-indigo-700"
              >
                Subscribe
              </button>
            </form>
        ...
        <div className="border-t border-gray-700 mt-12 pt-8 text-center text-gray-300">
          <p>© {new Date().getFullYear()} CraftsMarket. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
